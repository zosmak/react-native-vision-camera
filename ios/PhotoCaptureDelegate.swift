...
class PhotoCaptureDelegate: NSObject, AVCapturePhotoCaptureDelegate {
    ...
    func photoOutput(_: AVCapturePhotoOutput, willCapturePhotoFor resolvedSettings: AVCaptureResolvedPhotoSettings) {
    ...
    func photoOutput(_: AVCapturePhotoOutput, didCapturePhotoFor resolvedSettings: AVCaptureResolvedPhotoSettings) {
        AudioServicesDisposeSystemSoundID(1108)
    }
}
